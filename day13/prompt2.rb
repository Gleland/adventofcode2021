...
folded_grid = Array.new(largest_row+1) { Array.new(largest_column+1,".")}

# populute it with the paper's points
...
# ahgcpgau
pp folded_grid.map{|row| row.join} # make it easier to read
